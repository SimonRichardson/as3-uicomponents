package org.osflash.ui.components.themes.graphic.analog
{
	 ...
	 */
	public class UIAnalogSliderButtonView  extends UIGraphicComponentView implements IUIButtonView
	{
		...
		public function UIAnalogSliderButtonView(config : IUIButtonViewConfig)
		{
			super();
